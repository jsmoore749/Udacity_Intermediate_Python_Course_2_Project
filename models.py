...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname} has a diameter of {self.diameter:.3f} km and {haz_stat} potentially hazardous."
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        return f"At {self.time}, {self.name} approaches Earth at a distance of {self.distance:.2f} au and a velocity of {self.velocity:.2f} km/s"
